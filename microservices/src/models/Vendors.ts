...
@Table({
  tableName: Vendors.VAR_TABLE_NAME,
})

export class Vendors extends Model {
  public static VAR_TABLE_NAME = "vendors" as string;
  ...
  @Column({
    ...
    primaryKey: true,
    autoIncrement: true,
    field: Vendors.VAR_ID,
  })
  id!: number;

  @Column({
    type: DataType.STRING(100),
    field: Vendors.VAR_Vendor_Id,
  })
  vendor_id!: string;

  @Column({
    type: DataType.STRING(100),
    field: Vendors.VAR_Society_Id,
  })
  society_id!: string;

  @Column({
    type: DataType.STRING(100),
    field: Vendors.VAR_Name,
  })
  name!: string;

  @Column({
    type: DataType.STRING(100),
    field: Vendors.VAR_Address,
  })
  address!: string;

  @Column({
    type: DataType.STRING(100),
    field: Vendors.VAR_Email,
  })
  email!: string;

  @Column({
    type: DataType.STRING(100),
    field: Vendors.VAR_Specialisation,
  })
