...
@Table({
  tableName: Emails.VAR_TABLE_NAME,
})

export class Emails extends Model {
  public static VAR_TABLE_NAME = "emails" as string;
  ...
  @Column({
    ...
    field: Emails.VAR_Email_Id,
  })
  email_id!: string;

  @Column({
    type: DataType.STRING(100),
    field: Emails.VAR_Society_Id,
  })
  society_id!: string;

  @Column({
    type: DataType.STRING(100),
    field: Emails.VAR_From_Email,
  })
  from_email!: string;

  @Column({
    type: DataType.STRING(100),
    field: Emails.VAR_To_Email,
  })
  to_email!: string;

  @Column({
    type: DataType.STRING(100),
    field: Emails.VAR_Content,
  })
  content!: string;

  @Column({
    type: DataType.STRING(100),
    field: Emails.VAR_Is_Read,
  })
  is_read!: string;
